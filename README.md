...
- 📦 **Умный импорт:** Понимает не только классические ссылки `vless://`, но и умеет на лету разбирать сложные кастомные JSON-массивы подписок (полная совместимость с Hiddify и другими провайдерами, использующими закрытые клиентские API).
